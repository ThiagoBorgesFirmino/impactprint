...
if(! isset($ALLOWED_SITES)){
    ...
    */
    ...
    $ALLOWED_SITES = array (
        '192.168.40.128',
        '31.170.161.133',
        'ajungimgteste.ajungsolutions.com',
        'ajungsolutions.com',
        'baseprodutos.ajungsolutions.com'
    );
...
class timthumb {
    ...
    public function __construct(){
        ...
        if(FILE_CACHE_DIRECTORY){
            ...
            touch($this->cacheDirectory . '/index.tmp');
        } else {
        ...
        if($this->isURL){
            ...
            // print_r($this->src);
            // var_dump($this->getLocalImagePath($this->src));
    ...
    protected function getLocalImagePath($src){
        ...
        if(file_exists ($this->docRoot . '/' . $src)) {
            ...
            if(strpos($real, $realDocRoot) === 0){
                ...
                return $real;
                $this->debug(1, "Security block: The file specified occurs outside the document root. ({$real})");
    ...
    protected function debug($level, $msg){
        if(DEBUG_ON && $level <= DEBUG_LEVEL){
            ...
            error_log($txt="TimThumb Debug line " . __LINE__ . " [$execTime : $tick]: $msg");
            print ($txt)."<br>" ;
        }
    }
